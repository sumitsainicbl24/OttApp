...
export const styles = StyleSheet.create({
  ...
  epgProgramTitleFocused: {
    color: '#007AFF',
  },

  epgProgramTitlePlaying: {
    color: '#FFD700',
  },
  ...
  // Program Description Box Styles
  programDescriptionBox: {
    position: 'absolute',
    top: verticalScale(40),
    right: moderateScale(40),
    width: scale(600),
    backgroundColor:CommonColors.whiteOpacity20,
  ...
  programDescriptionHeader: {
    ...
    // color:CommonColors.whiteOpacity30
  },
  ...
  programDescriptionChannelLogoText: {
    fontFamily: FontFamily.PublicSans_Bold,
    fontSize: moderateScale(14),
    color: CommonColors.white,
  },

  programDescriptionTimeContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
    marginBottom: verticalScale(12),
