...
export const styles = StyleSheet.create({
  ...
  microphoneButton: {
    ...
    borderColor: CommonColors.backgroundGrey,
  },

  microphoneButtonFocused: {
    borderColor: CommonColors.white,
  },

  microphoneIconPlaceholder: {
    width: '100%',
    height: '100%',
    resizeMode: 'contain',
    tintColor: CommonColors.backgroundGrey,
    // This will be replaced with actual microphone icon
  },
  ...
  searchInputContainerFocused: {
    borderWidth: moderateScale(2),
    borderColor: CommonColors.buttonPrimary,
  },
