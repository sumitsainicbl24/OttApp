...
const LiveVideoComp = ({ streamUrl, onExit, timing, hideControls = false }: LiveVideoCompProps) => {
  ...
  const bottomControls = [
    ...
    { id: 'resolution', label: '1920 x 1080', icon: imagepath.buttons, value: '' },
    { id: 'audio', label: 'Stereo', icon: imagepath.unmuteIcon, value: '' },
    { id: 'delay', label: 'Delay', icon: imagepath.buttons, value: '' },
    { id: 'captions', label: 'Closed Captions', icon: imagepath.caption_icon, value: '' },
    { id: 'aspect', label: 'Normal', icon: imagepath.resize, value: '' },
